...
import { KEY_SERVICES } from "@/lib/wizzfly-constants";
  ...
  return (
    <section id="services" className="scroll-mt-20 bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          What are the key services offered by Wizzfly Overseas?
        </motion.h2>
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {KEY_SERVICES.map((service, i) => (
            ...
            >
              ...
              <h3 className="mt-4 font-poppins text-lg font-bold text-wizzfly-text-primary">{service.title}</h3>
              <p className="mt-2 text-sm text-wizzfly-text-secondary">{service.desc}</p>
              <Link
                href={service.href}
                className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-primary-orange hover:underline"
              >
                Learn More
